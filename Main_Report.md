...
| TC_FR-02_02  | Kiểm tra đăng nhập thành công sau khi hết thời gian phạt            | Email: test@eshop.com<br>Pass: Test1234!                      | Đăng nhập thành công.                                     | Đăng nhập thất bại. Phải reload lại page (F5) mới đăng nhập được.                                         | Fail   |
...
| **TC_FR-02_BVA_04** | Kiểm tra biên dưới thời gian khóa (t = 29s) | Tài khoản đang bị khóa, vừa trôi qua 29 giây | Email: test@eshop.com<br>Password: Test1234!<br>State: 3 lần sai, t = 29s | Đăng nhập thất bại, hệ thống báo lỗi tài khoản vẫn đang bị khóa.                   | Đăng nhập thất bại, Frontend chỉ hiện: “Đăng nhập thất bại, vui lòng kiểm tra lại”. Kể cả reset page đăng nhập lại cũng hiện tương tự. | Fail   |
| **TC_FR-02_BVA_05** | Kiểm tra tại biên thời gian khóa (t = 30s)  | Tài khoản bị khóa, vừa trôi qua đúng 30 giây | Email: test@eshop.com<br>Password: Test1234!<br>State: 3 lần sai, t = 30s | Đăng nhập thành công, trả về JWT Token, reset bộ đếm số lần sai về 0.              | Frontend hiện lỗi “Đăng nhập thất bại, vui lòng kiểm tra lại”. Bắt buộc phải tải lại trang (F5) rồi đăng nhập lại thì mới thành công.  | Fail   |
| **TC_FR-02_BVA_06** | Kiểm tra vượt biên thời gian khóa (t = 31s) | Tài khoản bị khóa, đã trôi qua 31 giây       | Email: test@eshop.com<br>Password: Test1234!<br>State: 3 lần sai, t = 31s | Đăng nhập thành công, trả về JWT Token, reset bộ đếm số lần sai về 0.              | Frontend hiện lỗi “Đăng nhập thất bại, vui lòng kiểm tra lại”. Bắt buộc phải tải lại trang (F5) rồi đăng nhập lại thì mới thành công.  | Fail   |
